...
Tracking::Tracking(System *pSys, FrameDrawer *pFrameDrawer, MapDrawer *pMapDrawer, Map *pMap, const string &strSettingPath, const int sensor, const bool bOnlyTracking):
    mState(NO_IMAGES_YET), mSensor(sensor), mbOnlyTracking(bOnlyTracking), mbVO(false), mpORBVocabulary(static_cast<ORBVocabulary*>(NULL)),
...
bool Tracking::TrackReferenceKeyFrame()
{
    ...
    if(mpORBVocabulary)
        ...
        nmatches = matcher.SearchByBF(mpReferenceKF,mCurrentFrame,vpMapPointMatches);
...
void Tracking::CreateNewKeyFrame()
{
    ...
    else
    {
        ...
        mpMap->AddKeyFrame(pKF);//zoe 20190523
    }
